...
if [[ "$SSL" = true ]]; then
    ...
    if [[ ! -f keystore.jks ]]; then
        ...
        keytool -importkeystore -deststorepass XL750BK -destkeypass XL750BK -destkeystore keystore.jks -srckeystore pkcs.p12 -srcstoretype PKCS12 -srcstorepass pass -alias IZOU
    fi
fi
