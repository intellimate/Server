...
public class AppActiveTag extends TableImpl<AppActiveTagRecord> {
	...
	private static final long serialVersionUID = -1097611906;

	/**
	 * The reference instance of <code>izou_server.App_Active_Tag</code>
	 */
	...
	/**
	 * The column <code>izou_server.App_Active_Tag.id_App_Active_Tag</code>.
	 */
	...
	/**
	 * The column <code>izou_server.App_Active_Tag.app</code>.
	 */
	...
	/**
	 * The column <code>izou_server.App_Active_Tag.tag</code>.
	 */
	...
	/**
	 * Create a <code>izou_server.App_Active_Tag</code> table reference
	 */
	public AppActiveTag() {
	...
	/**
	 * Create an aliased <code>izou_server.App_Active_Tag</code> table reference
	 */
