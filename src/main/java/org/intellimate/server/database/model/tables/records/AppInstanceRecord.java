...
public class AppInstanceRecord extends UpdatableRecordImpl<AppInstanceRecord> implements Record5<Integer, Integer, String, Boolean, String> {

    private static final long serialVersionUID = 948943131;
     ...
     */
    @Override
    public AppInstanceRecord values(Integer value1, Integer value2, String value3, Boolean value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppInstanceRecord(Integer idAppInstance, Integer appReference, String platform, Boolean active, String error) {
        super(AppInstance.APP_INSTANCE);
