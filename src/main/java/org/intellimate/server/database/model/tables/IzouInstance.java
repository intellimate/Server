...
public class IzouInstance extends TableImpl<IzouInstanceRecord> {
	...
	private static final long serialVersionUID = -909466836;

	/**
	 * The reference instance of <code>izou_server.Izou_Instance</code>
	 */
	...
	/**
	 * The column <code>izou_server.Izou_Instance.id_Instances</code>.
	 */
	...
	/**
	 * The column <code>izou_server.Izou_Instance.user</code>.
	 */
	...
	/**
	 * The column <code>izou_server.Izou_Instance.name</code>.
	 */
	...
	/**
	 * Create a <code>izou_server.Izou_Instance</code> table reference
	 */
	public IzouInstance() {
	...
	/**
	 * Create an aliased <code>izou_server.Izou_Instance</code> table reference
	 */
